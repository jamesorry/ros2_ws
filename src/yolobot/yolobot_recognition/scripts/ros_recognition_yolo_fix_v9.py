...
from my_robot_interfaces.msg import BoundingBoxesV2, BoundingBoxes, BoundingBox
...
class Camera_subscriber(Node):
    ...
    def yolovFive2bboxes_msgs(self, bboxes: list, scores: list, cls: list, img_header: Header):
        ...
        for score in scores:
            ...
            one_box.x_center = int(abs(
                one_box.xmax - one_box.xmin) / 2 + one_box.xmin)
            one_box.y_center = int(abs(
