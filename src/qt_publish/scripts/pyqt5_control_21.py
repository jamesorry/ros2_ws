...
# )
import cv2
from Test_11 import Ui_MainWindow
...
# ! 2023/5/25 將ui畫面中robot_2相關的畫面資料移除
...
class MainWindow_controller(QtWidgets.QMainWindow):
    ...
    def ros_main_loop(self):
        rclpy.init()
        self.node = Node('pyqt5_control_21')
        ...
        # ! 添加nav plan路徑
        self.nav_plan_subscription = self.node.create_subscription(
    ...
    def loadImage(self, img: SendMapImage):
        ...
        if(self.Map_Image is None):
            ...
            #     self.origin_width / 2) - self.fix_map_center_pixel_x
            # self.map_center_pixel_y = (
            #     self.origin_height / 2) - self.fix_map_center_pixel_y
            # self.init_map_img(self.Map_Image)
            self.init_map_img(self.Init_Map_Image)
            self.set_img_ratio()
    ...
    def setup_camera_window(self):
        ...
        self.robot_camera_img = {"Robot_1": None}
