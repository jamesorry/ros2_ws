...
import cv2
from Test_04 import Ui_MainWindow
...
class MainWindow_controller(QtWidgets.QMainWindow):
    ...
    def get_robot1_distance(self, data: BoundingBoxes):
        for score in data.bounding_boxes:
            ...
            self.yolo_result_robot1["probability"].append(score.probability)
            self.yolo_result_robot1["center_dist"].append(score.center_dist)
    ...
    def setup_controller(self):
        ...
        self.ui.groupBox_controller_robot1.clicked.connect(self.__groupBox_controller_robot1)
        ...
        self.ui.groupBox_controller_robot2.clicked.connect(self.__groupBox_controller_robot2)
    ...
    def _on_parameter_changed(self):
        ...
        self.fix_controller_send_twist_robot1(self.send_x_linear_robot1, self.send_z_angular_robot1)
        self.fix_controller_send_twist_robot2(self.send_x_linear_robot2, self.send_z_angular_robot2)
    ...
    def setup_fix_controller(self):
        ...
        self.ui.pushButton_move_forward_robot1.pressed.connect(self.move_forward_robot1)
        self.ui.pushButton_move_forward_robot1.setAutoRepeat(True)
        self.ui.pushButton_move_backward_robot1.pressed.connect(self.move_backward_robot1)
        self.ui.pushButton_move_backward_robot1.setAutoRepeat(True)
        self.ui.pushButton_right_rotate_robot1.pressed.connect(self.right_rotate_robot1)
        self.ui.pushButton_right_rotate_robot1.setAutoRepeat(True)
        self.ui.pushButton_left_rotate_robot1.pressed.connect(self.left_rotate_robot1)
        self.ui.pushButton_left_rotate_robot1.setAutoRepeat(True)
        self.ui.pushButton_fix_stop_moving_robot1.clicked.connect(self.stop_moving_robot1)
        self.ui.lineEdit_x_liner_robot1.setPlaceholderText("0.00~0.50")
        self.ui.lineEdit_x_liner_robot1.editingFinished.connect(self.x_liner_text_edit_robot1)
        self.ui.lineEdit_x_liner_robot1.setText(str(self.fix_controller_x_linear_robot1))
        self.ui.lineEdit_z_angular_robot1.setPlaceholderText("0.00~0.50")
        self.ui.lineEdit_z_angular_robot1.editingFinished.connect(self.z_angular_text_edit_robot1)
        self.ui.lineEdit_z_angular_robot1.setText(str(self.fix_controller_z_angular_robot1))
        self.ui.groupBox_fix_controller_robot1.clicked.connect(self.__groupBox_fix_controller_robot1)
        ...
        self.ui.pushButton_move_forward_robot2.pressed.connect(self.move_forward_robot2)
        self.ui.pushButton_move_forward_robot2.setAutoRepeat(True)
        self.ui.pushButton_move_backward_robot2.pressed.connect(self.move_backward_robot2)
        self.ui.pushButton_move_backward_robot2.setAutoRepeat(True)
        self.ui.pushButton_right_rotate_robot2.pressed.connect(self.right_rotate_robot2)
        self.ui.pushButton_right_rotate_robot2.setAutoRepeat(True)
        self.ui.pushButton_left_rotate_robot2.pressed.connect(self.left_rotate_robot2)
        self.ui.pushButton_left_rotate_robot2.setAutoRepeat(True)
        self.ui.pushButton_fix_stop_moving_robot2.clicked.connect(self.stop_moving_robot2)
        self.ui.lineEdit_x_liner_robot2.setPlaceholderText("0.00~0.50")
        self.ui.lineEdit_x_liner_robot2.editingFinished.connect(self.x_liner_text_edit_robot2)
        self.ui.lineEdit_x_liner_robot2.setText(str(self.fix_controller_x_linear_robot2))
        self.ui.lineEdit_z_angular_robot2.setPlaceholderText("0.00~0.50")
        self.ui.lineEdit_z_angular_robot2.editingFinished.connect(self.z_angular_text_edit_robot2)
        self.ui.lineEdit_z_angular_robot2.setText(str(self.fix_controller_z_angular_robot2))
        self.ui.groupBox_fix_controller_robot2.clicked.connect(self.__groupBox_fix_controller_robot2)
    ...
    def x_liner_text_edit_robot1(self):
        if self.ui.lineEdit_x_liner_robot1.text() != "":
            if float(self.ui.lineEdit_x_liner_robot1.text()) > 0.5:
                ...
                self.fix_controller_x_linear_robot1 = float(self.ui.lineEdit_x_liner_robot1.text())
    def z_angular_text_edit_robot1(self):
        if self.ui.lineEdit_z_angular_robot1.text() != "":
            if float(self.ui.lineEdit_z_angular_robot1.text()) > 0.5:
                ...
                self.fix_controller_z_angular_robot1 = float(self.ui.lineEdit_z_angular_robot1.text())
    def x_liner_text_edit_robot2(self):
        if self.ui.lineEdit_x_liner_robot2.text() != "":
            if float(self.ui.lineEdit_x_liner_robot2.text()) > 0.5:
                ...
                self.fix_controller_x_linear_robot2 = float(self.ui.lineEdit_x_liner_robot2.text())
    def z_angular_text_edit_robot2(self):
        if self.ui.lineEdit_z_angular_robot2.text() != "":
            if float(self.ui.lineEdit_z_angular_robot2.text()) > 0.5:
                ...
                self.fix_controller_z_angular_robot2 = float(self.ui.lineEdit_z_angular_robot2.text())