...
import cv2
from Test_06 import Ui_MainWindow
            ...
            if score.class_id in self.yolo_result_robot1["class_id"]:
                ...
                if self.check_num_robot1 > 10:
                    ...
                    if position != self.yolo_result_robot1["position"][list_num-1]:
                        self.yolo_result_robot1["class_id"][list_num -1] = score.class_id
                        self.yolo_result_robot1["probability"][list_num -1] = score.probability
                        self.yolo_result_robot1["center_dist"][list_num -1] = self.distance_mean_robot1
            ...
            if score.class_id in self.yolo_result_robot2["class_id"]:
                ...
                if self.check_num_robot2 > 10:
                    ...
                    if position != self.yolo_result_robot2["position"][list_num-1]:
                        self.yolo_result_robot2["class_id"][list_num -1] = score.class_id
                        self.yolo_result_robot2["probability"][list_num -1] = score.probability
                        self.yolo_result_robot2["center_dist"][list_num -1] = self.distance_mean_robot2
